...
import { Shield, Users, ArrowLeft, Zap, CloudSun } from "lucide-react";
...
export default function About() {
  ...
  const backButtonInView = useInView(backButtonRef, {
    once: true,
    margin: "-100px",
  });
  const serviceCard1InView = useInView(serviceCard1Ref, {
    once: true,
    margin: "-50px",
  });
  const serviceCard2InView = useInView(serviceCard2Ref, {
    once: true,
    margin: "-50px",
  });
  const serviceCard3InView = useInView(serviceCard3Ref, {
    once: true,
    margin: "-50px",
  });
      ...
      <div className="max-w-6xl mx-auto px-3 sm:px-4 lg:px-8 py-4 sm:py-6 md:py-8 lg:py-12">
        ...
        <motion.div
          ...
          <p className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl mx-auto px-2 sm:px-4 lg:px-0 leading-relaxed">
            Advanced AI-powered solar panel analysis platform with intelligent
            chat assistant for installation planning, fault detection, and
            expert consultation
          </p>
        </motion.div>
        ...
        <motion.div
          ...
          animate={
            whatWeDoInView ? { opacity: 1, x: 0 } : { opacity: 0, x: -100 }
          }
          transition={{ duration: 0.8, ease: "easeOut" }}>
          <Card className="mb-4 sm:mb-6 lg:mb-8 shadow-sm border-gray-200">
            ...
            <CardContent className="pt-0 px-4 sm:px-6">
              <p className="text-gray-700 mb-4 sm:mb-6 text-sm sm:text-base leading-relaxed">
                SolarScope AI leverages Google Gemini AI and advanced computer
                vision to provide dynamic, image-specific solar panel analysis.
                Our platform uses intelligent boundary detection and adaptive
                algorithms to analyze each rooftop individually, ensuring
                accurate panel placement recommendations based on actual roof
                characteristics rather than fixed patterns. Combined with
                comprehensive fault detection and an expert AI chat assistant,
                we deliver professional-grade solar consulting services.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-6">
                <motion.div
                  ...
                  <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-4 sm:p-6 border border-blue-200 hover:shadow-lg transition-shadow duration-300">
                    ...
                    <p className="text-sm text-gray-600 mb-4">
                      Dynamic AI analysis that adapts to each specific roof,
                      using intelligent boundary detection to ensure accurate
                      panel placement and realistic capacity calculations.
                    </p>
                ...
                <motion.div
                  ...
                  <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-4 sm:p-6 border border-green-200 hover:shadow-lg transition-shadow duration-300">
                    ...
                    <p className="text-sm text-gray-600 mb-4">
                      Advanced computer vision to identify micro-cracks, hot
                      spots, dirt accumulation, and other performance-affecting
                ...
                <motion.div
                  ...
                  <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg p-4 sm:p-6 border border-purple-200 hover:shadow-lg transition-shadow duration-300">
                    ...
                    <p className="text-sm text-gray-600 mb-4">
                      Interactive AI-powered chat assistant providing expert
                      guidance on solar panel installation, maintenance,
        ...
        <motion.div
          ...
          initial={{ opacity: 0, x: 100 }}
          animate={
            keyFeaturesInView ? { opacity: 1, x: 0 } : { opacity: 0, x: 100 }
          }
          transition={{ duration: 0.8, ease: "easeOut" }}>
          <Card className="mb-4 sm:mb-6 lg:mb-8 shadow-sm border-gray-200">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-3 sm:gap-4 lg:gap-6">
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600">
                    Powered by Google's latest Gemini AI model for accurate
                ...
                <div className="text-center">
                    ...
                    <div className="relative bg-white rounded-lg p-3 shadow-sm border border-green-200">
                      <div className="w-full h-full bg-gradient-to-br from-green-50 to-green-100 rounded flex items-center justify-center">
                        <div className="flex space-x-1">
                          ...
                          <div
                            className="w-1 h-5 bg-green-600 rounded animate-pulse"
                  ...
                  <p className="text-sm text-gray-600">
                    Instant processing of uploaded images with detailed analysis
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600">
                    Professional PDF reports with visual analysis, technical
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600">
                    Interactive AI-powered chat with voice input support for
                    instant expert guidance and consultation
                  </p>
                </div>
                <div className="text-center">
                  <div className="relative w-16 h-16 mx-auto mb-4">
                  ...
                  <p className="text-sm text-gray-600">
                    Advanced image recognition and analysis capabilities for
                    accurate solar panel assessment
                  </p>
                </div>
                <div className="text-center">
                  <div className="relative w-16 h-16 mx-auto mb-4">
                  ...
                  <p className="text-sm text-gray-600">
                    Adaptive algorithms that analyze each roof individually
                    without fixed coordinates for accurate results
                  </p>
                </div>
              </div>
            </CardContent>
        ...
        <motion.div
          ...
          animate={
            techStackInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 100 }
          }
          transition={{ duration: 0.8, ease: "easeOut" }}>
          <Card className="mb-4 sm:mb-6 lg:mb-8 shadow-sm border-gray-200">
            <CardHeader className="pb-4 sm:pb-6">
              ...
              <div className="relative bg-gradient-to-br from-gray-50 to-blue-50 rounded-lg p-4 sm:p-6 border border-gray-200">
                ...
                <div className="flex flex-col items-center mb-6 sm:mb-8">
                  ...
                  <div className="flex flex-wrap justify-center gap-2 sm:gap-3">
                    ...
                    <div className="flex items-center bg-white rounded-full px-3 sm:px-4 py-1.5 sm:py-2 shadow-md border border-blue-300 transform hover:scale-105 transition-transform">
                      <div
                        className="w-2.5 sm:w-3 h-2.5 sm:h-3 bg-blue-600 rounded-full mr-1.5 sm:mr-2 animate-pulse"
                        style={{ animationDelay: "0.2s" }}></div>
                      <span className="text-xs sm:text-sm font-medium">
                        TypeScript
                      </span>
                    ...
                    <div className="flex items-center bg-white rounded-full px-3 sm:px-4 py-1.5 sm:py-2 shadow-md border border-cyan-200 transform hover:scale-105 transition-transform">
                      <div
                        className="w-2.5 sm:w-3 h-2.5 sm:h-3 bg-cyan-500 rounded-full mr-1.5 sm:mr-2 animate-pulse"
                        style={{ animationDelay: "0.4s" }}></div>
                      <span className="text-xs sm:text-sm font-medium">
                        Tailwind CSS
                      </span>
                    ...
                    <div className="flex items-center bg-white rounded-full px-3 sm:px-4 py-1.5 sm:py-2 shadow-md border border-indigo-200 transform hover:scale-105 transition-transform">
                      <div
                        className="w-2.5 sm:w-3 h-2.5 sm:h-3 bg-indigo-500 rounded-full mr-1.5 sm:mr-2 animate-pulse"
                ...
                <div className="flex flex-col items-center mb-6 sm:mb-8">
                  ...
                  <div className="flex flex-wrap justify-center gap-2 sm:gap-3">
                    ...
                    <div className="flex items-center bg-white rounded-full px-3 sm:px-4 py-1.5 sm:py-2 shadow-md border border-gray-200 transform hover:scale-105 transition-transform">
                      <div
                        className="w-2.5 sm:w-3 h-2.5 sm:h-3 bg-gray-500 rounded-full mr-1.5 sm:mr-2 animate-pulse"
                        style={{ animationDelay: "0.2s" }}></div>
                      <span className="text-xs sm:text-sm font-medium">
                        Express.js
                      </span>
                    ...
                    <div className="flex items-center bg-white rounded-full px-3 sm:px-4 py-1.5 sm:py-2 shadow-md border border-blue-200 transform hover:scale-105 transition-transform">
                      <div
                        className="w-2.5 sm:w-3 h-2.5 sm:h-3 bg-blue-500 rounded-full mr-1.5 sm:mr-2 animate-pulse"
                        style={{ animationDelay: "0.4s" }}></div>
                      <span className="text-xs sm:text-sm font-medium">
                        PostgreSQL
                      </span>
                    ...
                    <div className="flex items-center bg-white rounded-full px-3 sm:px-4 py-1.5 sm:py-2 shadow-md border border-orange-200 transform hover:scale-105 transition-transform">
                      <div
                        className="w-2.5 sm:w-3 h-2.5 sm:h-3 bg-orange-500 rounded-full mr-1.5 sm:mr-2 animate-pulse"
                        style={{ animationDelay: "0.6s" }}></div>
                      <span className="text-xs sm:text-sm font-medium">
                        Drizzle ORM
                      </span>
                ...
                <div className="flex justify-center mb-6 sm:mb-8">
                  <div className="flex flex-col items-center">
                    ...
                    <div
                      className="w-2.5 sm:w-3 h-2.5 sm:h-3 bg-purple-400 rounded-full animate-bounce"
                ...
                <div className="flex flex-col items-center">
                  ...
                  <div className="flex flex-wrap justify-center gap-2 sm:gap-3">
                    ...
                    <div className="flex items-center bg-white rounded-full px-3 sm:px-4 py-1.5 sm:py-2 shadow-md border border-pink-200 transform hover:scale-105 transition-transform">
                      <div
                        className="w-2.5 sm:w-3 h-2.5 sm:h-3 bg-pink-500 rounded-full mr-1.5 sm:mr-2 animate-pulse"
                        style={{ animationDelay: "0.2s" }}></div>
                      <span className="text-xs sm:text-sm font-medium">
                        Computer Vision
                      </span>
                    ...
                    <div className="flex items-center bg-white rounded-full px-3 sm:px-4 py-1.5 sm:py-2 shadow-md border border-teal-200 transform hover:scale-105 transition-transform">
                      <div
                        className="w-2.5 sm:w-3 h-2.5 sm:h-3 bg-teal-500 rounded-full mr-1.5 sm:mr-2 animate-pulse"
                        style={{ animationDelay: "0.4s" }}></div>
                      <span className="text-xs sm:text-sm font-medium">
                        Natural Language
                      </span>
                    ...
                    <div className="flex items-center bg-white rounded-full px-3 sm:px-4 py-1.5 sm:py-2 shadow-md border border-black transform hover:scale-105 transition-transform">
                      <div
                        className="w-2.5 sm:w-3 h-2.5 sm:h-3 bg-black rounded-full mr-1.5 sm:mr-2 animate-pulse"
                        style={{ animationDelay: "0.6s" }}></div>
                      <span className="text-xs sm:text-sm font-medium">
                        Render
                      </span>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 lg:gap-6">
                <div className="relative">
                  <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg p-4 border-l-4 border-blue-500">
                    ...
                    <p className="text-sm text-gray-600">
                      Dynamic roof analysis with intelligent boundary detection
                      for accurate panel placement and realistic capacity
                      planning
                    </p>
                  </div>
                </div>
                <div className="relative">
                  <div className="bg-gradient-to-r from-green-50 to-green-100 rounded-lg p-4 border-l-4 border-green-500">
                    ...
                    <p className="text-sm text-gray-600">
                      AI-powered fault detection with severity-based maintenance
                      recommendations and professional PDF reports
                    </p>
                  </div>
                </div>
                <div className="relative">
                  <div className="bg-gradient-to-r from-purple-50 to-purple-100 rounded-lg p-4 border-l-4 border-purple-500">
                    ...
                    <p className="text-sm text-gray-600">
                      Single-image rooftop analysis with adaptive panel sizing
                      and comprehensive installation planning reports
                    </p>
                  </div>
                </div>
                <div className="relative">
                  <div className="bg-gradient-to-r from-orange-50 to-orange-100 rounded-lg p-4 border-l-4 border-orange-500">
                    ...
                    <p className="text-sm text-gray-600">
                      Professional AI chat assistant with expert solar knowledge
                      and dynamic analysis capabilities for client consultation
                    </p>
                  </div>
                </div>
              </div>
        ...
        <motion.div
          ...
          initial={{ opacity: 0, y: 50 }}
          animate={
            backButtonInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 50 }
          }
          transition={{ duration: 0.8, ease: "easeOut" }}>
          <Link href="/">
