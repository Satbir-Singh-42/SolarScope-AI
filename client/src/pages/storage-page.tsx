...
export default function StoragePage() {
  ...
  const [dataSource, setDataSource] = useState<"database" | "session" | "none">(
    "none",
  );
  ...
  const analyses =
    dataSource === "database" && dbAnalyses.length > 0
      ? dbAnalyses
      : cachedAnalyses;
  ...
  // PDF export handlers
  const exportInstallationPDF = async (
    analysis: Analysis,
  ...
  const exportFaultDetectionPDF = async (
    analysis: Analysis,
    type: "complete" | "summary" = "complete",
  ) => {
    try {
        ...
        <div className="container mx-auto px-4 py-8 pt-24">
          <div className="text-center">
            ...
            <p className="text-sm sm:text-base text-gray-600 mb-6">
              Please login to view your stored analyses.
            </p>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 pt-24 max-w-7xl">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div className="w-full sm:w-auto">
                  <div className="flex justify-center sm:justify-end space-x-4 sm:space-x-6 text-sm">
                    <div className="text-center">
                      <div className="font-bold text-lg sm:text-base text-blue-600">
                    ...
                    <div className="text-center">
                      <div className="font-bold text-lg sm:text-base text-red-600">
                        {userInfo.faultDetectionCount}
                      </div>
                      <div className="text-gray-500 text-xs sm:text-sm">
                        Fault Detection
                      </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="text-sm sm:text-base text-gray-600">
                Manage your installation and fault detection analyses with
            ...
            <div className="flex items-center gap-2">
              ...
              {error && dataSource === "session" && (
                <Badge
                  variant="outline"
                  className="text-xs text-yellow-600 bg-yellow-50">
                  Using Cached Data
                </Badge>
              )}
            </div>
        ...
        <Tabs
          value={activeTab}
          onValueChange={(value) =>
            setActiveTab(value as "installation" | "fault-detection")
          }>
              ...
              <Card>
                <CardContent className="text-center py-12">
                  ...
                  <h3 className="text-lg font-medium text-gray-900 mb-2">
                    No Installation Analyses
                  </h3>
                  <p className="text-gray-600">
                    Complete an installation analysis to see your results here.
                  </p>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-xl">
                    Installation Analyses ({installationAnalyses.length})
                  </CardTitle>
                  <p className="text-sm text-gray-600">
                    Your solar panel installation analysis history
                  </p>
                </CardHeader>
                <CardContent>
                  <div className="overflow-x-auto">
                    <Table>
                      <TableHeader>
                        <TableRow>
                          <TableHead className="w-12 sm:w-16 px-1 sm:px-3">
                            #
                          </TableHead>
                          <TableHead className="px-1 sm:px-3">
                            Date & Time
                          </TableHead>
                          <TableHead className="hidden sm:table-cell px-1 sm:px-3">
                            Analysis Type
                          </TableHead>
                          <TableHead className="text-right px-1 sm:px-3">
                            PDF
                          </TableHead>
                        </TableRow>
                      </TableHeader>
                            ...
                            <TableRow
                              ...
                              <TableCell className="text-right px-1 sm:px-3">
                                <Button
                                  size="sm"
                                  onClick={() =>
                                    exportInstallationPDF(analysis, "complete")
                                  }
            ...
            {faultAnalyses.length === 0 ? (
              <Card>
                <CardContent className="text-center py-12">
                  ...
                  <h3 className="text-lg font-medium text-gray-900 mb-2">
                    No Fault Detection Analyses
                  </h3>
                  <p className="text-gray-600">
                    Complete a fault detection analysis to see your results
                    here.
                  </p>
                  <Button asChild className="mt-4">
                    <a href="/dashboard">Start Analysis</a>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-xl">
                    Fault Detection Analyses ({faultAnalyses.length})
                  </CardTitle>
                  <p className="text-sm text-gray-600">
                    Your solar panel fault detection analysis history
                  </p>
                </CardHeader>
                <CardContent>
                  <div className="overflow-x-auto">
