        ...
        if (file) {
          ...
          try {
            ...
            setValidationResult({
              ...
              description:
                "Please upload a valid image file or try again later.",
            });
            setShowValidationCard(true);
      ...
      <>
        ...
        <Card className="shadow-material">
          <CardContent className="p-4 sm:p-6 md:p-8">
            <h3 className="text-lg sm:text-xl md:text-2xl font-bold mb-4 sm:mb-6 text-primary-custom">
              {title}
            </h3>
            ...
            {!uploadedFile ? (
              <div
                ...
                <p className="text-xs sm:text-sm text-secondary-custom mb-3 sm:mb-4">
              ...
              <div className="space-y-4">
                ...
                {onAnalyze && (
                  <Button
                    ...
                    disabled={
                      uploading || isValidating || !validationResult?.isValid
                    }
            ...
            <p className="text-xs sm:text-sm text-secondary-custom mt-4 px-2">
              {description}
            </p>
          </CardContent>
        </Card>
