...
export default function InstallationAnalysis() {
    ...
    if (analysisResult) {
      try {
        ...
        try {
          ...
          console.warn(
            "Failed to save analysis result even after cleanup:",
            retryError,
          );
        }
      }
  ...
  const analysisMutation = useMutation({
    ...
    onError: (error) => {
      ...
      if (error instanceof Error) {
        ...
        if (
          errorText.includes("not a rooftop") ||
          errorText.includes("no roof") ||
          errorText.includes("solar panel")
        ) {
          errorTitle = "Invalid Image for Installation Analysis";
          errorMessage =
            "Please upload a rooftop or building image. This feature analyzes roof structures for solar panel installation planning, not existing solar panels.";
        } else if (
          ...
          errorMessage =
            "Please upload an outdoor rooftop image. Indoor or interior photos cannot be used for solar installation planning.";
        } else if (
          ...
          errorMessage =
            "Please upload a clear rooftop image showing the building structure from an aerial or angled view.";
        } else if (
  ...
  const exportCompletePDF = async () => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "Comprehensive installation analysis report has been downloaded as a PDF.",
        variant: "success",
      });
    } catch (error) {
      ...
      toast({
        title: "Export Failed",
        description:
          "Failed to generate complete PDF report. Please try again.",
        variant: "destructive",
      });
    }
  };
  ...
  const exportToJson = () => {
    ...
    toast({
      title: "Data Exported",
      description:
        "Installation analysis data has been downloaded as a JSON file.",
    });
  };
      ...
      <Card className="shadow-material">
        <CardHeader
          ...
          <p className="text-xs sm:text-sm text-gray-600 mt-1">
            Specify roof details to help our AI focus on rooftop analysis and
            create more accurate solar panel placement recommendations
          </p>
        </CardHeader>
        <AnimatePresence>
          {isRoofDetailsOpen && (
                ...
                <motion.div
                  ...
                  <motion.div
                    ...
                    <Select
                      ...
                      <SelectContent>
                        <SelectItem value="auto-optimize">
                          Auto-optimize for roof
                        </SelectItem>
      ...
      {(analysisResult || analysisMutation.isPending) && (
        <div
            ...
            <Card className="shadow-material">
              <CardContent className="p-3 sm:p-4 lg:p-6">
                <div className="flex items-center justify-between mb-3 sm:mb-4 lg:mb-6">
                  <h4 className="text-base sm:text-lg md:text-xl font-bold text-primary-custom">
                    AI Analysis Results
                  </h4>
                  {analysisResult && (
                    <Button
          ...
          <div className="order-2 xl:order-2">
            <Card className="shadow-material">
              <CardContent className="p-3 sm:p-4 lg:p-6">
                <h4 className="text-base sm:text-lg md:text-xl font-bold mb-3 sm:mb-4 text-primary-custom">
                  Installation Recommendations
                </h4>
                    ...
                    <div>
                      <div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 md:gap-4 mb-4 sm:mb-6">
                          {[
                            {
                              value: analysisResult.totalPanels,
                            ...
                            {
                              value: `${Math.round(Number(analysisResult.coverage))}%`,
                              label: "Roof Coverage",
                              color: "green",
                              bgColor: "bg-green-50",
                            ...
                            {
                              value: `${Math.round(Number(analysisResult.powerOutput))}kW`,
                              label: "Est. Power Output",
                              color: "purple",
                            ...
                            <div
                              ...
                              <div
                                className={`text-lg sm:text-xl md:text-2xl font-bold ${metric.textColor}`}>
                                {metric.value}
                              </div>
                              <div className="text-xs sm:text-sm text-secondary-custom">
                                {metric.label}
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 md:gap-4 mb-4 sm:mb-6">
                            ...
                            {analysisResult.usableRoofArea && (
                              <div className="bg-cyan-50 p-2 sm:p-3 md:p-4 rounded-lg hover:shadow-md transition-shadow cursor-pointer">
                                <div className="text-lg sm:text-xl md:text-2xl font-bold text-cyan-700">
                                  {analysisResult.usableRoofArea}
                                </div>
                                <div className="text-xs sm:text-sm text-secondary-custom">
                                  Usable Area (sq ft)
                        ...
                        {/* Financial Details */}
                        {analysisResult.calculationDetails && (
                          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-3 md:gap-4 mb-4 sm:mb-6">
                            <div className="bg-emerald-50 p-2 sm:p-3 md:p-4 rounded-lg hover:shadow-md transition-shadow cursor-pointer">
                            ...
                            <div className="bg-amber-50 p-2 sm:p-3 md:p-4 rounded-lg hover:shadow-md transition-shadow cursor-pointer">
                            ...
                            <div className="bg-indigo-50 p-2 sm:p-3 md:p-4 rounded-lg hover:shadow-md transition-shadow cursor-pointer">
                              <div className="text-lg sm:text-xl md:text-2xl font-bold text-indigo-700">
                                {
                                  analysisResult.calculationDetails
                                    .paybackPeriod
                                }{" "}
                        ...
                        <div className="space-y-3 sm:space-y-4">
                          <div className="border-l-4 border-green-500 pl-3 sm:pl-4">
                            <h5 className="font-medium text-sm sm:text-base text-primary-custom">
                              Optimal Orientation
                            </h5>
                          ...
                          <div className="border-l-4 border-blue-500 pl-3 sm:pl-4">
                            ...
                            <p className="text-xs sm:text-sm text-secondary-custom">
                              {analysisResult.shadingAnalysis}
                            </p>
                          </div>
                            ...
                            <div className="text-xs sm:text-sm text-secondary-custom">
                              {analysisResult.notes
                                ...
                                .filter(
                                  (line) =>
                                    line.trim() !== "" &&
                                    !line.includes("Installation Notes") &&
                                    !line.includes("Installation notes:"),
                                ) // Remove duplicate heading and empty lines
                                .map((line, index) => {
                                      ...
                                      <div
                                        ...
                                        {parts.map((part, i) =>
                                          i % 2 === 1 ? (
                                            <strong
                                              key={i}
                                              className="font-semibold text-primary-custom">
                                              {part}
                                            </strong>
                                          ) : (
                                            part
                                  ...
                                  if (
                                    ...
                                    return (
                                      <div
                                        key={index}
                                        className="ml-2 mb-1 flex items-start">
                                  ...
                                  if (
                                    ...
                                    return (
                                      <h6
                                        key={index}
                                        className="font-semibold text-primary-custom mt-4 mb-2 text-base">
                                        {line.replace(/\*\*/g, "")}
                                      </h6>
                                    );
                                  }
